                    ...
                    <div class="table-responsive" ">
                        <table class="table table-striped table-sm">
                            <tr style="display: none;">
                                ...
                                <td><b>:</b></td>
                                <td><input size="35" type="text" name="productId" value='<s:property value="productId"/>' readonly></td>
                            </tr>
                            <tr>
                                <td><b>Product Name</b></td>
                                <td><b>:</b></td>
                                <td><input size="35" type="text" name="productName" value='<s:property value="productName"/>'></td>
                            </tr>
                            <tr>
                                <td><b>Product make</b></td>
                                <td><b>:</b></td>
                                <td><input size="35" type="text"  name="productMake" value='<s:property value="productMake"/>'>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td><b>:</b></td>
                                <td>
                                    <textarea rows="5" cols="38" type="text"  name="productSpecification" value='<s:property value="productSpecification"/>'><s:property value="productSpecification"/></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td><b>Product Price</b></td>
                                <td><b>:</b></td>
                                <td><input size="35" type="text" name="productPrice" value='<s:property value="productPrice"/>'></td>
                            </tr>
                            <tr>
                                <td><b>Product Availability</b></td>
                                <td><b>:</b></td>
                                <td><input size="35" type="text" name="availability" value='<s:property value="availability"/>'></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td></td>

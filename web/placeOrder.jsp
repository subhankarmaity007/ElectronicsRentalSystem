                                        ...
                                        <tbody>
                                            <s:iterator value='%{sessionMap.get("productsInCart")}'>
                                                <tr>
                                                    ...
                                                    <td><input type="date" value='<s:property value="startDate"/>' name="startDate" id='StartDate_<s:property value="productId"/>'></td>

                                                    <td><input type="date" value='<s:property value="endDate"/>' name="endDate" id='EndDate_<s:property value="productId"/>'></td>
                                                    <td>
                                             ...
                                             <tr>
                                                ...
                                                <td> <a href="viewPrice" class="btn btn-outline-success">View Price</a></td>
